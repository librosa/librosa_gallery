...
(0 minutes 7.905 seconds)



.. container:: sphx-glr-download

    **Download Python source code:** :download:`plot_segmentation.py <plot_segmentation.py>`


.. container:: sphx-glr-download

    **Download IPython notebook:** :download:`plot_segmentation.ipynb <plot_segmentation.ipynb>`
